...
TOKEN_TYPE_MAP = {
    ...
    TokenType.UI_ELEMENT_PROPERTY_KEY: 8,
    TokenType.ZCONFIG_KEY: 9,
    TokenType.ZSPARK_KEY: 10,
    TokenType.ZENV_CONFIG_KEY: 11,
    TokenType.ZNAVBAR_NESTED_KEY: 12,
    TokenType.ZSUB_KEY: 13,
    TokenType.ZSPARK_NESTED_KEY: 14,
    TokenType.ZCONFIG_NESTED_KEY: 15,
    TokenType.ZSPARK_MODE_VALUE: 16,
    TokenType.ZSPARK_VAFILE_VALUE: 17,
    TokenType.ZSPARK_SPECIAL_VALUE: 18,
    TokenType.ENV_CONFIG_VALUE: 19,
    TokenType.ZRBAC_KEY: 20,
    TokenType.ZRBAC_OPTION_KEY: 21,
    TokenType.TYPE_HINT: 22,
    TokenType.NUMBER: 23,
    TokenType.STRING: 24,
    TokenType.BOOLEAN: 25,
    TokenType.NULL: 26,
    TokenType.BRACKET_STRUCTURAL: 27,
    TokenType.BRACE_STRUCTURAL: 28,
    TokenType.STRING_BRACKET: 29,
    TokenType.STRING_BRACE: 30,
    TokenType.COLON: 31,
    TokenType.COMMA: 32,
    TokenType.ESCAPE_SEQUENCE: 33,
    TokenType.VERSION_STRING: 34,
    TokenType.TIMESTAMP_STRING: 35,
    TokenType.TIME_STRING: 36,
    TokenType.RATIO_STRING: 37,
    TokenType.ZPATH_VALUE: 38,
    TokenType.ZMACHINE_EDITABLE_KEY: 39,
    TokenType.ZMACHINE_LOCKED_KEY: 40,
    TokenType.TYPE_HINT_PAREN: 41,
}
