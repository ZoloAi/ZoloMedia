...
TOKEN_TYPE_MAP = {
    ...
    TokenType.CONTROL_FLOW_KEY: 7,
    TokenType.UI_ELEMENT_KEY: 8,
    TokenType.UI_ELEMENT_PROPERTY_KEY: 9,
    TokenType.ZCONFIG_KEY: 10,
    TokenType.ZSPARK_KEY: 11,
    TokenType.ZENV_CONFIG_KEY: 12,
    TokenType.ZNAVBAR_NESTED_KEY: 13,
    TokenType.ZSUB_KEY: 14,
    TokenType.ZSPARK_NESTED_KEY: 15,
    TokenType.ZCONFIG_NESTED_KEY: 16,
    TokenType.ZSPARK_MODE_VALUE: 17,
    TokenType.ZSPARK_VAFILE_VALUE: 18,
    TokenType.ZSPARK_SPECIAL_VALUE: 19,
    TokenType.ENV_CONFIG_VALUE: 20,
    TokenType.ZRBAC_KEY: 21,
    TokenType.ZRBAC_OPTION_KEY: 22,
    TokenType.TYPE_HINT: 23,
    TokenType.NUMBER: 24,
    TokenType.STRING: 25,
    TokenType.BOOLEAN: 26,
    TokenType.NULL: 27,
    TokenType.BRACKET_STRUCTURAL: 28,
    TokenType.BRACE_STRUCTURAL: 29,
    TokenType.STRING_BRACKET: 30,
    TokenType.STRING_BRACE: 31,
    TokenType.COLON: 32,
    TokenType.COMMA: 33,
    TokenType.ESCAPE_SEQUENCE: 34,
    TokenType.VERSION_STRING: 35,
    TokenType.TIMESTAMP_STRING: 36,
    TokenType.TIME_STRING: 37,
    TokenType.RATIO_STRING: 38,
    TokenType.ZPATH_VALUE: 39,
    TokenType.ZMACHINE_EDITABLE_KEY: 40,
    TokenType.ZMACHINE_LOCKED_KEY: 41,
    TokenType.TYPE_HINT_PAREN: 42,
}
