...
TOKEN_TYPE_MAP = {
    ...
    TokenType.ZCONFIG_NESTED_KEY: 14,
    TokenType.ZSPARK_MODE_VALUE: 15,
    TokenType.ZSPARK_VAFILE_VALUE: 16,
    TokenType.ZSPARK_SPECIAL_VALUE: 17,
    TokenType.ENV_CONFIG_VALUE: 18,
    TokenType.ZRBAC_KEY: 19,
    TokenType.ZRBAC_OPTION_KEY: 20,
    TokenType.TYPE_HINT: 21,
    TokenType.NUMBER: 22,
    TokenType.STRING: 23,
    TokenType.BOOLEAN: 24,
    TokenType.NULL: 25,
    TokenType.BRACKET_STRUCTURAL: 26,
    TokenType.BRACE_STRUCTURAL: 27,
    TokenType.STRING_BRACKET: 28,
    TokenType.STRING_BRACE: 29,
    TokenType.COLON: 30,
    TokenType.COMMA: 31,
    TokenType.ESCAPE_SEQUENCE: 32,
    TokenType.VERSION_STRING: 33,
    TokenType.TIMESTAMP_STRING: 34,
    TokenType.TIME_STRING: 35,
    TokenType.RATIO_STRING: 36,
    TokenType.ZPATH_VALUE: 37,
    TokenType.ZMACHINE_EDITABLE_KEY: 38,
    TokenType.ZMACHINE_LOCKED_KEY: 39,
    TokenType.TYPE_HINT_PAREN: 40,
}
