...
TOKEN_TYPE_MAP = {
    ...
    TokenType.ZSPARK_NESTED_KEY: 8,
    TokenType.ZSPARK_MODE_VALUE: 9,
    TokenType.ZSPARK_VAFILE_VALUE: 10,
    TokenType.ZSPARK_SPECIAL_VALUE: 11,
    TokenType.ENV_CONFIG_VALUE: 12,
    TokenType.ZRBAC_KEY: 13,
    TokenType.ZRBAC_OPTION_KEY: 14,
    TokenType.TYPE_HINT: 15,
    TokenType.NUMBER: 16,
    TokenType.STRING: 17,
    TokenType.BOOLEAN: 18,
    TokenType.NULL: 19,
    TokenType.BRACKET_STRUCTURAL: 20,
    TokenType.BRACE_STRUCTURAL: 21,
    TokenType.STRING_BRACKET: 22,
    TokenType.STRING_BRACE: 23,
    TokenType.COLON: 24,
    TokenType.COMMA: 25,
    TokenType.ESCAPE_SEQUENCE: 26,
    TokenType.VERSION_STRING: 27,
    TokenType.TIMESTAMP_STRING: 28,
    TokenType.TIME_STRING: 29,
    TokenType.RATIO_STRING: 30,
    TokenType.ZPATH_VALUE: 31,
    TokenType.ZMACHINE_EDITABLE_KEY: 32,
    TokenType.ZMACHINE_LOCKED_KEY: 33,
    TokenType.TYPE_HINT_PAREN: 34,
}
