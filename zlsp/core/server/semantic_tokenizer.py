...
TOKEN_TYPE_MAP = {
    ...
    TokenType.ZRBAC_KEY: 8,
    TokenType.ZRBAC_OPTION_KEY: 9,
    TokenType.TYPE_HINT: 10,
    TokenType.NUMBER: 11,
    TokenType.STRING: 12,
    TokenType.BOOLEAN: 13,
    TokenType.NULL: 14,
    TokenType.BRACKET_STRUCTURAL: 15,
    TokenType.BRACE_STRUCTURAL: 16,
    TokenType.STRING_BRACKET: 17,
    TokenType.STRING_BRACE: 18,
    TokenType.COLON: 19,
    TokenType.COMMA: 20,
    TokenType.ESCAPE_SEQUENCE: 21,
    TokenType.VERSION_STRING: 22,
    TokenType.TIMESTAMP_STRING: 23,
    TokenType.TIME_STRING: 24,
    TokenType.RATIO_STRING: 25,
    TokenType.ZPATH_VALUE: 26,
    TokenType.ZMACHINE_EDITABLE_KEY: 27,
    TokenType.ZMACHINE_LOCKED_KEY: 28,
    TokenType.TYPE_HINT_PAREN: 29,
}
